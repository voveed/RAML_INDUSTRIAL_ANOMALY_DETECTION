...
if __name__ == '__main__':
    ...
    print("\n" + "="*60)
    print("🔬 [PHASE 2 - KAGGLE] RUNNING BASELINE: FIXED MARGIN 0.5")
    print("="*60)
    
    run = {'name': 'Fixed Margin (0.5)', 'epochs': 20, 'lr': 5e-5, 'margin_base': 0.5, 'lambda_sigma': 0.0, 'lambda_resolution': 0.0}
    ...
    print(f"✅ Final Result Fixed Margin (0.5): {score*100:.2f}%")
    os.makedirs("../checkpoints", exist_ok=True)
    torch.save(model.state_dict(), "../checkpoints/model_Fixed_Margin_05.pt")
    print("💾 Saved checkpoint to ../checkpoints/model_Fixed_Margin_05.pt")
    ...
    with open("../results/result_Fixed_Margin_05.json", "w") as f:
        json.dump(result_data, f, indent=4)
    print("💾 Saved results to ../results/result_Fixed_Margin_05.json")
